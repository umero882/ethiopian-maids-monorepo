...
// Default country (Ethiopia for this app)
export const DEFAULT_COUNTRY = COUNTRY_CODES.find(c => c.code === 'ET') || COUNTRY_CODES[0];

// GCC countries (common destinations for this platform)
export const GCC_COUNTRIES = COUNTRY_CODES.filter(c =>
  ['SA', 'AE', 'KW', 'QA', 'BH', 'OM'].includes(c.code)
);
