  ...
  ({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:border-purple-500',
  ...
  ({ className, children, position = 'popper', ...props }, ref) => (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ref={ref}
        className={cn(
          'relative z-[100] max-h-96 min-w-[8rem] overflow-hidden rounded-md border bg-popover bg-white text-popover-foreground shadow-lg',
  ...
  ({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        'focus:bg-purple-100 focus:text-purple-900 hover:bg-purple-50',
