...
const consentItems: ConsentItem[] = [
  ...
  },
  {
    ...
    description: 'I consent to background verification of matched workers',
    required: true,
  },
  {
    id: 'communicationConsent',
    title: 'Communication',
    description: 'I agree to receive notifications about potential matches',
    required: true,
  },
  {
    id: 'marketingConsent',
...
export default function SponsorConsentsScreen() {
  ...
  const [consents, setConsents] = useState<Record<string, boolean>>({
    ...
    backgroundCheckConsent: state.consents.backgroundCheckConsent || false,
    communicationConsent: state.consents.communicationConsent || false,
    marketingConsent: state.consents.marketingConsent || false,
  });
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
          ...
          {consentItems.map((item) => (
            <View key={item.id} style={styles.consentItem}>
              ...
              <Switch
                ...
                trackColor={{ false: '#E5E7EB', true: '#1E40AF50' }}
                thumbColor={consents[item.id] ? '#1E40AF' : '#fff'}
              />
            </View>
          ))}
        </View>
        ...
        {!allRequiredAccepted && (
          ...
          >
            <Ionicons name="checkmark-done" size={20} color="#1E40AF" />
