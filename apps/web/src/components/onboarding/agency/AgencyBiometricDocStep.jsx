  ...
  return (
    <div className="space-y-4">
      ...
      >
          ...
          <AnimatePresence mode="wait">
            ...
            {activeSection === 'document' && (
              <motion.div key="document" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
                {renderDocUpload('front', '📄 Front Side (Required)', 'Upload front of ID or Business License', 'agency-doc-front', fileInputRef)}
                {renderDocUpload('back', '📄 Back Side (Optional for Passport)', 'Upload back of ID', 'agency-doc-back', backFileInputRef)}
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-white/5 rounded-lg p-2 flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-400">Business ID (front + back)</span>
                  </div>
                </div>
              </motion.div>
            )}
        ...
        <StepTip>
          Your agency verification helps build trust with clients and workers.
        </StepTip>
      </StepCard>
