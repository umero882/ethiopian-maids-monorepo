          ...
          <AnimatePresence mode="wait">
            ...
            {activeSection === 'document' && (
              <motion.div key="document" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
                {renderDocUpload('front', '📄 Emirates ID - Front (Required)', 'Upload front of your Emirates ID', 'agency-doc-front', fileInputRef)}
                {renderDocUpload('back', '📄 Emirates ID - Back (Required)', 'Upload back of your Emirates ID', 'agency-doc-back', backFileInputRef)}
